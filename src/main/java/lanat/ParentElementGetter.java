 ...
 * This interface also provides a method with a default implementation for getting the root object.
...
public interface ParentElementGetter<T extends ParentElementGetter<T>> {
	...
	/**
	 * Gets the root object in the hierarchy it belongs to. If this object is already the root, then this
	 * object is returned.
