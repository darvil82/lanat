...
/**
 * Represents a layout item in the help message generated by {@link HelpFormatter}.
 * This class is essentially just a builder with some helper commands for setting a {@link Function} that
 * generates a {@link String} for a given {@link Command}.
 * @see HelpFormatter
 */
public class LayoutItem {
	...
	/**
	 * Creates a new {@link LayoutItem} with the given {@link Function} that generates a {@link String}
	 * for a given {@link Command}.
	...
	/**
	 * Sets the indent of the layout item. The indent is the number of indents that are added to the
	 * content of the layout item. The indent size is defined by {@link HelpFormatter#setIndentSize(int)}.
	...
	/**
	 * Sets the margin at the top of the layout item. The margin is the number of newlines that are added
	 * before the content of the layout item.
	...
	/**
	 * Sets the margin at the bottom of the layout item. The margin is the number of newlines that are added
	 * after the content of the layout item.
	...
	/**
	 * Sets the title of the layout item. The title is added before the content of the layout
	 * item. The title is not indented.
	 * <p>
	 * It is shown as:
	 * <pre>
	 * &lt;title&lt;:
	 ...
	 * The reason this method requires a {@link HelpFormatter} is because it provides the indent size and
	 * the parent command.
