...
public abstract class ErrorFormatter implements ErrorLevelProvider {
	...
	/**
	 * Generates the tokens view for a parse error when the error is a {@link Error.ParseError}.
	 * <p>
	...
	/**
	 * Generates the input view for a tokenize error when the error is a {@link Error.TokenizeError}.
	 * <p>
