...
import io.github.darvil.lanat.utils.CommandUser;
...
public final class DescriptionParser {
	...
	public static @NotNull String parse(@NotNull NamedWithDescription user, @NotNull String desc) {
		...
		for (int i = 0; i < chars.length; i++) {
			...
			if (chr == '\\') {
				...
				buff.append(DescriptionParser.parseTag(user, tagStr));
	 ...
	 */
	private static @NotNull String parseTag(@NotNull NamedWithDescription user, @NotNull String tagContents) {
